   ...
   return (
     <div className="bg-[#1f8278] p-4 rounded-lg overflow-auto h-full">
       ...
       <p className="text-sm sm:text-base ">
         ...
         then he has been on a journey to simply learn and tinker more.
       </p>
       ...
       <p className="  text-sm sm:text-base">
         ...
         United States including hiking in Arizona, snowboarding in Colorado, and
         climbing in the Badlands. He plans to backpack across Eruope and live
         in the mountains of Colorado in the future. Sources say hes a big
         lifter and prioritizes his health.
       </p>
       <div className="flex mt-2 grid-cols-3 gap-10 justify-center">
         <Image
           src="/snowboard.png"
           width={200}
           height={200}
